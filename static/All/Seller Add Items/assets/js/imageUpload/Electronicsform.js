//I added event handler for the file upload control to access the files properties.
        ...
        function ApplyFileValidationRules(readerEvt)
        {
            ...
            if (CheckFileType(readerEvt.type) == false) {
                alert("The Image (" + readerEvt.name + ") does not match the upload conditions, You can only upload jpg/png/gif Images");
                e.preventDefault();
                return;
            }
            ...
            if (CheckFileSize(readerEvt.size) == false) {
                alert("The Image (" + readerEvt.name + ") does not match the upload conditions, The maximum file size for uploads should not exceed 600 KB");
                e.preventDefault();
                return;
            }
